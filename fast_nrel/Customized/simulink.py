...
def simulation(parameters):
    ...
    if os.path.isdir(path_fast+turbinefast+' - Customized Simulation - Simulink') == False:
        os.mkdir(path_fast+turbinefast+' - Customized Simulation - Simulink')
    if os.path.isdir(path_fast+turbinefast+' - Customized Simulation - Simulink/'+turbinefast+'-'+str(v)+'ms') == False:
        os.mkdir(path_fast+turbinefast+' - Customized Simulation - Simulink/'+turbinefast+'-'+str(v)+'ms')

    new_path = path_fast+turbinefast+' - Customized Simulation - Simulink/'+turbinefast+'-'+str(v)+'ms/'
    ...
    if len(insert_aerocomponents)>40:
        airfoil_number_line=insert_aerocomponents[46].split()
        airfoil_number = int(airfoil_number_line[0])

        Aero_blade1_line = insert_aerocomponents[49+airfoil_number].split()
        Aero_blade2_line = insert_aerocomponents[50+airfoil_number].split()
        Aero_blade3_line = insert_aerocomponents[51+airfoil_number].split()
    ...
    eng.workspace['matlab_from_python'] = mfile
    eng.workspace['WindSpeed_from_python']=str(v)
    eng.workspace['Turbulence_from_python']= str(t)
    eng.workspace['Time_from_python']= str(s)
    eng.workspace['ReferenceHeight_from_python']= str(h)
    eng.workspace['SimulationNumber_from_python']= str(n)
...
def plot(parameters):
    ...
    if os.path.isdir(path_fast+turbinefast+' - Customized Simulation - Simulink/'+turbinefast+'-'+str(v)+'ms/'+str(t)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+' - Output data')==False:
        os.mkdir(path_fast+turbinefast+' - Customized Simulation - Simulink/'+turbinefast+'-'+str(v)+'ms/'+str(t)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+' - Output data')

    sim_path = path_fast+turbinefast+' - Customized Simulation - Simulink/'+turbinefast+'-'+str(v)+'ms/'

    out_file = sim_path+turbinefast+'-'+str(v)+'ms-'+str(t)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+'.Sfunc.out'
