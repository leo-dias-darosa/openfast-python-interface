...
def IEC_outputs(parameters):
    ...
    if os.path.exists(path_fast+turbinefast+'-'+str(v)+'ms/Sfunc Outputs - IEC61400.13 Outputs/'+turbinefast+'-'+str(v)+'ms-'+str(t)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+'/Individual pitch controller')==False:
        ...
        new_path = path_fast+turbinefast+'-'+str(v)+'ms/Sfunc Outputs - IEC61400.13 Outputs/'+turbinefast+'-'+str(v)+'ms-'+str(t)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+'/Individual pitch controller/'
...
def User_outputs(parameters):
    ...
    if os.path.exists(path_fast+turbinefast+'-'+str(v)+'ms/Sfunc Outputs - User Outputs/'+turbinefast+'-'+str(v)+'ms-'+str(t)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+'/Individual pitch controller')==False:
        ...
        new_path = path_fast+turbinefast+'-'+str(v)+'ms/Sfunc Outputs - User Outputs/'+turbinefast+'-'+str(v)+'ms-'+str(t)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+'/Individual pitch controller/'
        out = turbinefast+'-'+str(v)+'ms-'+str(t)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+'.sfunc.out'
