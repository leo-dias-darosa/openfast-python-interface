...
def report(parameters):
    ...
    sim_path = path_fast+turbinefast+' - Customized Simulation - Fast/'
    
    Simulation = 'Customized FAST'

    simulated_file = path_fast+turbinefast+' - Customized Simulation - Fast/'+turbinefast+'-'+str(v)+'ms/'+turbinefast+'-'+str(v)+'ms-'+str(t)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)
...
#################################################################################################  AERODYNAMIC SUMMARY ################################################################################################
    ...
    aero_file = open(path_fast+turbinefast+' - Customized Simulation - Fast/'+turbinefast+'-'+str(v)+'ms/Aero.dat').read().splitlines()
...
####################################################################################################### GET DATA #####################################################################################################
    ...
    for v in wind_speed:
        ...
        for turb in turb_list:
            if os.path.exists(path_fast+turbinefast+' - Customized Simulation - Fast/'+turbinefast+'-'+str(v)+'ms/'+turbinefast+'-'+str(v)+'ms-'+str(turb)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+'.out')==False:
                pass
            else:
                read_path = path_fast+turbinefast+' - Customized Simulation - Fast/'+turbinefast+'-'+str(v)+'ms/'
    ...
    mppt_folder = path_fast+turbinefast+' - Customized Simulation - Fast/'+turbinefast+'-'+str(mppt_plot)+'ms/'+str(t)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+' - Output data/'
    speed_control_folder = path_fast+turbinefast+' - Customized Simulation - Fast/'+turbinefast+'-'+str(speed_control_plot)+'ms/'+str(t)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+' - Output data/'
...
#######################################################################################################################################################################################################################
    ...
    tex_file= turbinefast+' Fast - Customized Report.tex'
