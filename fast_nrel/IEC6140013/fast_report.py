...
def report(parameters):
        ...
        simulated_file = path_fast+turbinefast+' - Customized Simulation - Fast/'+turbinefast+'-'+str(v)+'ms/'+turbinefast+'-'+str(v)+'ms-'+str(t)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+'/'+turbinefast+'-'+str(v)+'ms-'+str(t)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)
...
#################################################################################################  AERODYNAMIC SUMMARY ################################################################################################
        ...
        aero_file = open(path_fast+turbinefast+' - Customized Simulation - Fast/'+turbinefast+'-'+str(v)+'ms/'+turbinefast+'-'+str(v)+'ms-'+str(t)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+'/Aero.dat').read().splitlines()
...
####################################################################################################### GET DATA #####################################################################################################
        ...
        for v in wind_speed:
                ...
                for turb in range(5,26):
                        if os.path.exists(path_fast+turbinefast+' - Customized Simulation - Fast/'+turbinefast+'-'+str(v)+'ms/'+turbinefast+'-'+str(v)+'ms-'+str(turb)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+'/'+turbinefast+'-'+str(v)+'ms-'+str(turb)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+'.out')==False:
                                pass
                        else:
                                read_path = path_fast+turbinefast+' - Customized Simulation - Fast/'+turbinefast+'-'+str(v)+'ms/'+turbinefast+'-'+str(v)+'ms-'+str(turb)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+'/'
        ...
        mppt_folder = path_fast+turbinefast+' - Customized Simulation - Fast/'+turbinefast+'-'+str(mppt_plot)+'ms/'+turbinefast+'-'+str(mppt_plot)+'ms-'+str(t)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+'/Output Data/'
        speed_control_folder = path_fast+turbinefast+' - Customized Simulation - Fast/'+turbinefast+'-'+str(speed_control_plot)+'ms/'+turbinefast+'-'+str(speed_control_plot)+'ms-'+str(t)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+'/Output Data/'
