...
def simulation(parameters,wind_style=1):
    ...
    if os.path.isdir(path_fast+turbinefast+' Power Curve - IEC61400.12 - Simulink') == False:
        os.mkdir(path_fast+turbinefast+' Power Curve - IEC61400.12 - Simulink')
    if os.path.isdir(path_fast+turbinefast+' Power Curve - IEC61400.12 - Simulink/'+turbinefast+' - '+str(s)+'s of duration bins')==False:
        os.mkdir(path_fast+turbinefast+' Power Curve - IEC61400.12 - Simulink/'+turbinefast+' - '+str(s)+'s of duration bins')

    new_path = path_fast+turbinefast+' Power Curve - IEC61400.12 - Simulink/'+turbinefast+' - '+str(s)+'s of duration bins/'
    ...
    for v in wind_speed:
        for t in turb:
            for n in range(n_1,n_2):
                sim_path = path_fast+turbinefast+' Power Curve - IEC61400.12 - Simulink/'+turbinefast+' - '+str(s)+'s of duration bins/'
