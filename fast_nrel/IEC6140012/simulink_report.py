...
def report(parameters):
        ...
        sim_path = path_fast+turbinefast+' Power Curve - IEC61400.12 - Simulink/'
        
        Simulation = 'Power Curve - IEC61400.12 - Simulink'

        simulated_file = sim_path+turbinefast+' - '+str(s)+'s of duration/bins/'+turbinefast+'-'+str(v)+'ms-'+str(t)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+'/'+turbinefast+'-'+str(v)+'ms-'+str(t)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+'.sfunc'
...
#################################################################################################  AERODYNAMIC SUMMARY ################################################################################################
        ...
        aero_file = open(sim_path+turbinefast+' - '+str(s)+'s of duration/bins/'+turbinefast+'-'+str(v)+'ms-'+str(t)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+'/Aero.dat').read().splitlines()
...
####################################################################################################### GET DATA #####################################################################################################
        ...
        for v in wind_speed:
                ...
                for turb in range(t,t+1):
                        if os.path.exists(sim_path+turbinefast+' - '+str(s)+'s of duration/bins/'+turbinefast+'-'+str(v)+'ms-'+str(turb)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+'/'+turbinefast+'-'+str(v)+'ms-'+str(turb)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+'.sfunc.out')==False:
                                pass
                        else:
                                read_path = sim_path+turbinefast+' - '+str(s)+'s of duration/bins/'+turbinefast+'-'+str(v)+'ms-'+str(turb)+'ti-'+str(h)+'m-'+str(s)+'s-'+str(n)+'/'
...
######################################################################################################## Report ######################################################################################################
        ...
        main = r'''
            ...
            \begin{figure}[H]
	    \centering
	    \includegraphics[width=0.90\linewidth]{{"'''+sim_path+turbinefast+r''' - '''+str(s)+r'''s of duration/'''+turbinefast+r''' - Power curve, PC and Scatter plot"}.png}
...
#######################################################################################################################################################################################################################
        ...
        tex_file= turbinefast+' - Simulink - Power Curve - IEC61400-12 Report.tex'
